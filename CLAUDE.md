...
**Tests:** 110 passing, 1 ignored (render doctest)
...
1. **Resource Leveling** (`crates/utf8proj-solver/src/leveling.rs`)
...
2. **TJP Integration Tests** (`crates/utf8proj-solver/tests/hierarchical_scheduling.rs`)
